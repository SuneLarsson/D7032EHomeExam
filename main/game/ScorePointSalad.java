    ...
    public void setupScore(ArrayList<IPlayer> players){
        for (IPlayer player : players) {
            if (player instanceof BotPlayer) {
                ...
                botPlayer.setScore(PointSaladCriteria.calculateScore(botPlayer, players));
            }
            else if (player instanceof OnlinePlayer) {
                // Handle online player actions
                OnlinePlayer onlinePlayer = (OnlinePlayer) player;
                onlinePlayer.setScore(PointSaladCriteria.calculateScore(onlinePlayer, players));
            } else   {
                // Handle local player actions
                LocalPlayer localPlayer = (LocalPlayer) player;
                localPlayer.setScore(PointSaladCriteria.calculateScore(localPlayer, players));
            }
        }
    }
